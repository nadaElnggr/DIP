function [image,GMatrix] = Piecewise(image,GMatrix)
% Create a new figure
fig = figure('Name','Piecewise','Color',[1 0.95 0.86],'Position',[350,20,600,400],'MenuBar','none','NumberTitle','off');
% Create the label
label = uicontrol(fig,'style','text','string','Piecewise','Position',[5,550,400,40],'BackgroundColor',[1 0.95 0.86],'Fontweight','bold','Fontsize',12,'ForegroundColor', [0.23 0.60 0.73],'FontName','Wide Latin');
...
switch(button_number)
    ...
    case 2
        string = "Thresholding";
    case 3
        string ="GrayLevelSlicing1";
    case 4
        string="GrayLevelSlicing2";
    case 5
        string ="BitPlaneSlicing";
    case 6
        string ="HistogramEqualization";
    case 7 
        string ="Back";
    case 8
        string ="Reset";
...
function buttonCallback(~, ~, button_number)
    switch button_number
    case 1
        TwoInputs(image,GMatrix,"ContrastStretching");
        close(fig);
    case 2
        BasicGUI(image,GMatrix,"Thresholding");
        close(fig);
    case 3
        TwoInputs(image,GMatrix,"GrayLevelSlicing1");
        close(fig);
    case 4
        TwoInputs(image,GMatrix,"GrayLevelSlicing2");
        close(fig);
    case 5
        SubPlot8(image,GMatrix,"BitPlaneSlicing");
        close(fig);
    case 6
        NoInput(image,GMatrix,"HistogramEqualization");
        close(fig);
    case 7
        Spatial;
        close(fig);
