function [image,GMatrix] = Smoothing(image,GMatrix)
% Create a new figure
...
switch(button_number)
    case 1
        string = "Average(simple)";
    case 2
        string = "Average(weighted)";
    case 3
        string ="Median";
    case 4
        string="Min";
...
function buttonCallback(~, ~, button_number)
    switch button_number
    case 1
        BasicGUI(image,GMatrix,"Average_Simple");
        close(fig);
    case 2 
        NoInput(image,GMatrix,"Average_Weighted")
        close(fig);
    case 3
        BasicGUI(image,GMatrix,"Median");
        close(fig);
    case 4
        NoInput(image,GMatrix,"MIN");
        close(fig);
    case 5
        NoInput(image,GMatrix,"MAX");
        close(fig);
    case 6
        Spatial;
        close(fig);
